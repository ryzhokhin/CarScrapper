...
from matplotlib.figure import Figure
import matplotlib
from testik.features_full import get_final_x_y_fromWholeData, getDatForUserMakeReqPreReadyToGraph
...
#
# frame = tk.Tk()
# frame.title("Car Anal")
# frame.geometry('1080x720')
#
# # Function for getting Input
# # from textbox and printing it
# # at label widget
# USER_REQUEST_TEXT_BOX = ''
#
#
# def userRequestAllOrModel():
#
#     f = Figure(figsize=(6, 4), dpi=100)
#     ax = f.add_subplot(111)
#     ax.clear()
#     global USER_REQUEST_TEXT_BOX
#     tmp = inputtxt.get(1.0, "end-1c")
#     USER_REQUEST_TEXT_BOX = tmp
#     # lbl.config(text="Provided Input: " + inp)
#     print(USER_REQUEST_TEXT_BOX)
#     x_usr_req, y_usr_req = '',''
#     if USER_REQUEST_TEXT_BOX == 'All':
#         x_usr_req, y_usr_req = get_final_x_y_fromWholeData(carsJson)
#         # graphingData(x_all_makes, y_all_makes)
#         # graphDataForTkinter(x_all_makes, y_all_makes)
#     else:
#         x_usr_req, y_usr_req = getDatForUserMakeReqPreReadyToGraph(USER_REQUEST_TEXT_BOX)
#         # graphingData(x_usr_req, y_usr_req)
#         # graphDataForTkinter(x_usr_req, y_usr_req)
#         # print('Something went wrong')
#     rects1 = ax.bar(x_usr_req, y_usr_req)
#     canvas = FigureCanvasTkAgg(f, master=frame)
#     canvas.draw()
#     canvas.get_tk_widget().pack(side=tk.RIGHT, expand=0)
#
#
#
#
...
label = tk.Label(text = "Hello pidor")

btn = tk.Button(frame, text="main anal", command=plotingdata)
btn.pack()
text_box_1 = tk.Text(frame, height=5, width=20)
text_box_1.pack()
label.pack()
